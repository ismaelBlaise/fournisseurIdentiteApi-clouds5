...
class UtilisateurUpdateDTO
{
    ...
    public function __construct(string $nom, string $prenom, Carbon $date_naissance, string $mot_de_passe, int $id_sexe)
    {
        $this->nom = $nom;
        $this->prenom = $prenom;
    ...
    {
        return "UtilisateurUpdateDTO{nom='{$this->nom}', prenom='{$this->prenom}', date_naissance='{$this->date_naissance->toDateString()}', mot_de_passe='{$this->mot_de_passe}', id_sexe={$this->id_sexe}}";
    }
}
